...
\begin{table}[H]
    \begin{tabular}{ |C{0.01\textwidth}|C{0.1\textwidth}|C{0.1\textwidth}|C{0.02\textwidth}|C{0.02\textwidth}|C{0.03\textwidth}|C{0.1\textwidth}|C{0.2\textwidth}|C{0.02\textwidth}|C{0.02\textwidth}|C{0.03\textwidth}|C{0.1\textwidth}| }
        ...
        \hline 
        1 & Krankheit & Weniger Arbeitstage & W5 & S4 & \cellcolor{red}Hoch & Risikominderung &    & W5 & S1 & \cellcolor{yellow}Mittel & Risikoakzeptanz \\
        \hline
        ...
        \hline
        4 &  & Verschiebung der IPA & W2 & S4 & \cellcolor{yellow}Mittel & Risikoakzeptanz  &  & W2 & S4 & \cellcolor{yellow}Mittel & Risikoakzeptanz\\
        \hline
    \end{tabular}
